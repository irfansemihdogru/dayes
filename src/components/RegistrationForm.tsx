        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input id="studentName" placeholder="Adı" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="studentSurname">Öğrenci Soyadı</Label>
              <Input id="studentSurname" placeholder="Soyadı" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="studentId">T.C. Kimlik No</Label>
              <Input id="studentId" placeholder="11 haneli TC Kimlik No" maxLength={11} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="parentName" placeholder="Veli Adı" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="parentSurname">Veli Soyadı</Label>
              <Input id="parentSurname" placeholder="Veli Soyadı" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="address" placeholder="Ev Adresi" />
            </div>
            <div className="space-y-2">
